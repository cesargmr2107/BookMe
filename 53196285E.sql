...
CREATE TABLE `RESERVAS` (
  ...
  `FECHA_RESPUESTA_RECURSO`    date NULL COMMENT 'FECHA EN QUE SE AUTORIZA/RECHAZA LA RESERVA POR EL RESPONSABLE',
...
-- Para tabla 'RESERVAS'
INSERT INTO `RESERVAS` (`LOGIN_USUARIO`, `ID_RECURSO`, `FECHA_SOLICITUD_RESERVA`, `FECHA_RESPUESTA_RECURSO`, `MOTIVO_RECHAZO_RESERVA`, `ESTADO_RESERVA`, `COSTE_RESERVA`) VALUES
('emmolina15', '1', '2020-11-14', NULL, NULL, 'PENDIENTE', '20'),
